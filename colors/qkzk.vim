...
let s:palette.regexp    = {'dark': "#95E6CB",  'light': "#338844"}
...
let s:palette.visual    = {'dark': "#088075",  'light': "#5ADBBB"}
...
if has("nvim")
  ...
  let g:terminal_color_3 =  s:palette.keyword[s:style]
  ...
  let g:terminal_ansi_colors += [s:palette.keyword[s:style],  s:palette.accent[s:style]]
  let g:terminal_ansi_colors += [s:palette.tag[s:style],     s:palette.constant[s:style]]
